...
public class TraineeController {
    ...
    public ResponseEntity<List<TrainingReadDto>> getTraineeTrainings(@PathVariable String username) {
        List<TrainingReadDto> trainings = traineeService.getTraineeTrainings(username);
